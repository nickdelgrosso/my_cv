...
\begin{itemize}
\item
To continually improve my teaching, programming, and project management skills.
\end{itemize}
\begin{itemize}
\item
...
\NewEntry{2015 {-} Present}{Proofreader}{Freelance Proofreader}{Proofread and Edited research papers for graduate students in medicine, neuroscience, and philosophy to programming}
...
\includegraphics[width=5cm]{images/Signaturetransparant.png}%
\end{cv}%
>>>>>>> ce8e35a0f1df981c2ef00c89d259b3a71108a7aa
\end{document}