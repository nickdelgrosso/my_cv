...
\NewEntry{July 2018}{Programming Instructor}{Lehrstatistik mit R}{This 4{-}day workshop is an intensive R course taught to the Psychology department professors at Kwantlen University in Vancouver, Canada.  In this course, they learned the R programming language and how to build statistics teaching materials with it.}%
