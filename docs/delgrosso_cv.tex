...
\NewEntry{Summer 2016 and Summer 2017}{Lecturer}{Introduction to Scientific Programming in Python}{In this semester course, taught two years in a row, I taught beginning programmers data management, scientific data analysis, and programming skills in a new language (Python).  Besides organizing and planning the course, I also prepared all course materials, homework assignments, and graded their final projects.}%
